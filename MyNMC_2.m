...
for i = 1:numel(unique(Ytr)) % for the amount of possible classifications
    ...
    % these testing points, returning means for i classes
     ...
     for j = 1:size(Zts,1) % for all of the points to be tested
         ...
         NewLabels(j,1) = unique(Ytr(I)); % creates a new label vector for the labels of the testing data
         % using the index of the column for the value which had the minumum distance
     end     
end
